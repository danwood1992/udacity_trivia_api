...
export default function WelcomeBlock({quizData}:WelcomeBlockProps) {
  ...
  return(
    <Container className='grid justify-items-center p-8 bg-slate-400 '>

      <BlockHeading text='Welcome to UdaciTrivia' className='text-6xl p-6' />
      <div> A Project for the Udacity Full Stack Nano Degree</div>   
      <div className='text-md'>By: <a className=' text-pale-sky' href="https://github.com/danwood1992">Dan Wood</a></div>
    </Container>
  )
}
